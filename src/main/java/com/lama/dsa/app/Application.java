...
@SpringBootApplication(scanBasePackages = {"com.lama.dsa.foodRepository"
...
@EnableMongoRepositories(basePackages = {"com.lama.dsa.foodRepository","com.lama.dsa.orderRepository"})
